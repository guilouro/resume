...
### **[dLocal](https://dlocal.com/)** _(Aug 2025 - Present)_
**(Remote)**

- Develop and maintain core frontend solutions within the IT Core team, focusing on scalable and reliable interfaces that support dLocal's global payments platform.
- Lead frontend development for internal back-office tools that support pricing, quoting, commercial rules configuration, and cost management for payment operations, using React, TypeScript, Next.js, and modern tooling to deliver intuitive and performant user experiences.
- Collaborate closely with product, operations, and other engineering teams to translate business and compliance requirements into robust, user-friendly internal applications that streamline day-to-day workflows.
- Contribute to the evolution of architecture and frontend patterns, improving maintainability, consistency, and observability across critical internal tools.
- Drive code quality through thoughtful code reviews, technical discussions, and clear documentation, aligning the team around best practices and shared standards.
- Mentor and support teammates by sharing knowledge about modern React/TypeScript, testing, and frontend architecture, elevating the overall engineering capacity of the team.

_**Skills: TypeScript, React, Next.js, Unit & Integration Testing, Code Reviews, Documentation, Mentoring, Frontend Architecture, Observability, Design System**_
...
_**Skills: TypeScript, React, Redux, Saga, Vanilla JavaScript, Chrome Extension development, GraphQL, Styled Components, Tailwind CSS, Monorepos (Turborepo), AWS (S3, CloudFront), Docker, GitHub Actions, CircleCI, Git, PostgreSQL, Unit & Integration Testing, React Testing Library, Jest/Vitest, Playwright, Micro Frontends, Design System, OpenAI, AI, LLMs, AI Agents**_
...
_**Skills: TypeScript, React, Next.js, GraphQL, Styled Components, Monorepos (Turborepo), AWS, Docker, GitHub Actions, PostgreSQL, Unit & Integration Testing, React Testing Library, Jest, Cypress, Micro Frontends, Design System, SEO**_
...
_**Skills: React, Redux, Vanilla JavaScript, Styled Components, Monorepos (Turborepo), AWS (S3, CloudFront), Docker, GitHub Actions, Git, PostgreSQL, Unit & Integration Testing, Enzyme, Jest, Micro Frontends, Design System**_
...
_**Skills: React, Redux, Python, Falcon, Styled Components, AWS (S3, CloudFront, CloudFormation), Docker, GitHub Actions, Git, PostgreSQL, Unit & Integration Testing, Enzyme, Jest, Cypress, Micro Frontends, Design System**_
...
- Designed and built a [custom PHP framework](https://github.com/guilouro/lothus-php) that streamlined project development, significantly accelerating delivery times and improving scalability, which contributed to the company’s growth.
...
_**Skills: PHP, MySQL, Node.js, OOP, AngularJS, JavaScript, jQuery, CSS, DigitalOcean, Infrastructure, Automation, Unit & Integration Testing, SEO, Technical Leadership, Mentoring, Fast Delivery**_
